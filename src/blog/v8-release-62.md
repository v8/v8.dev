...
<figure>
  <img src="/_img/v8-release-62/perf.png" alt="">
</figure>
...
<figure>
  <img src="/_img/v8-release-62/speedometer.png" alt="">
</figure>
...
<figure>
  <img src="/_img/v8-release-62/hashcode-lookups.png" alt="">
</figure>
...
Developers with an [active V8 checkout](https://github.com/v8/v8/wiki/Using%20Git) can use `git checkout -b 6.2 -t branch-heads/6.2` to experiment with the new features in V8 v6.2. Alternatively you can [subscribe to Chrome’s Beta channel](https://www.google.com/chrome/browser/beta.html) and try the new features out yourself soon.
