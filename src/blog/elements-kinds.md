...
To figure out a given object’s “elements kind”, get a debug build of `d8` (see [“Building from source”](https://github.com/v8/v8/wiki/Building-from-Source)), and run:
