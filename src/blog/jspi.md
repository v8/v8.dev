...
However, it is not permitted to block the browser’s main thread; and
...
This compiles our program, creating a loadable HTML file (b.html). The
...
In a situation where we want to dynamically load code, we would like
